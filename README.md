...
`public/library/scratch-catalog.json` is checked in and regenerated by
...
and 353 sounds' worth of names, tags, and MD5 identifiers, no bytes. See
...
The starter assets in `public/library/` were authored for this project. The Scratch catalog
points at media served by `assets.scratch.mit.edu` under
[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) — see
[`public/library/LICENSE.md`](public/library/LICENSE.md).
